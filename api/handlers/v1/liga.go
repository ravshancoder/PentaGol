...
import (
	...
	pu "github.com/PentaGol/genproto/liga"
...
func (h *handlerV1) CreateLiga(c *gin.Context) {
	...
	response, err := h.strg.Liga().CreateLiga(&pu.LigaRequest{
		Name: body.Name,
	})
...
func (h *handlerV1) GetLigaById(c *gin.Context) {
	...
	response, err := h.strg.Liga().GetLigaById(&pu.IdRequest{Id: int64(id)})
	if err != nil {
...
func (h *handlerV1) GetAllLigas(c *gin.Context) {
	...
	response, err := h.strg.Liga().GetAllLigas(&pu.AllLigaRequest{
		Limit: params.Limit,
		Page:  params.Page,
	})
	if err != nil {
...
func (h *handlerV1) DeleteLiga(c *gin.Context) {
	...
	response, err := h.strg.Liga().DeleteLiga(&pu.IdRequest{
		Id: int64(id),
	})
...
func (h *handlerV1) CreateGame(c *gin.Context) {
	...
	response, err := h.strg.Game().CreateGame(&pu.GameRequest{
		Time:             body.Time,
...
func (h *handlerV1) GetGameById(c *gin.Context) {
	...
	response, err := h.strg.Game().GetGameById(&pu.IdRequest{Id: int64(id)})
	if err != nil {
		statusCode := http.StatusInternalServerError
		if status.Code(err) == codes.NotFound {
			statusCode = http.StatusNotFound
...
func (h *handlerV1) GetAllGames(c *gin.Context) {
	...
	response, err := h.strg.Game().GetAllGames(&pu.AllGameRequest{
		Limit: params.Limit,
		Page:  params.Page,
	})
	if err != nil {
...
func (h *handlerV1) DeleteGame(c *gin.Context) {
	...
	response, err := h.strg.Game().DeleteGame(&pu.IdRequest{
		Id: int64(id),
	})
...
func (h *handlerV1) CreateClub(c *gin.Context) {
	...
	response, err := h.strg.Club().CreateClub(&pu.ClubRequest{
		Name:   body.Name,
...
func (h *handlerV1) GetClubById(c *gin.Context) {
	...
	response, err := h.strg.Club().GetClubById(&pu.IdRequest{Id: int64(id)})
	if err != nil {
		statusCode := http.StatusInternalServerError
		if status.Code(err) == codes.NotFound {
			statusCode = http.StatusNotFound
...
func (h *handlerV1) GetAllClubs(c *gin.Context) {
	...
	response, err := h.strg.Club().GetAllClubs(&pu.AllClubRequest{
		Limit: params.Limit,
		Page:  params.Page,
	})
	if err != nil {
