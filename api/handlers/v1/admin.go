...
import (
	...
	pu "github.com/PentaGol/genproto/admin"
	"github.com/PentaGol/pkg/etc"
...
func (h *handlerV1) CreateAdmin(c *gin.Context) {
	...
	response, err := h.strg.Admin().CreateAdmin(&pu.AdminRequest{
		Name:         body.Name,
		Email:        body.Email,
		Password:     password,
...
func (h *handlerV1) GetAdminById(c *gin.Context) {
	...
	response, err := h.strg.Admin().GetAdminById(&pu.IdRequest{Id: int64(id)})
	if err != nil {
